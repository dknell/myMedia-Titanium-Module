...
-(id)moduleGUID
{
	return @"d9a23a29-98b1-456e-93d9-fdc85ed0f0ec";
}
...
-(NSArray*)queryMusicLibrary:(id)arg
{
    ...
    for (NSString* prop in [MyMediaModule filterableItemProperties]) {
        ...
        if (value != nil) {
            if ([value isKindOfClass:[NSDictionary class]]) {
                ...
                [predicates addObject:[MPMediaPropertyPredicate predicateWithValue:propVal 
                                                                       forProperty:[[MyMediaModule filterableItemProperties] valueForKey:prop]
...
- (void)imagePickerController:(UIImagePickerController *)picker_ didFinishPickingMediaWithInfo:(NSDictionary *)editingInfo
{
	...
	// START myMedia
	////////////////////////////////////////////////////////////////////////////////////////////////////
	NSURL *imageRefURL = [editingInfo valueForKey:UIImagePickerControllerReferenceURL];
	...
	void (^ALAssetsLibraryAssetForURLResultBlock)(ALAsset *) = ^(ALAsset *asset)
    {
		if (asset != nil)
		{
			...
			NSArray *defRep = [asset valueForProperty:ALAssetPropertyRepresentations];
