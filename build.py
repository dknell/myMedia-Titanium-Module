...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','my.media.js')
	...
	f = os.path.join(cwd,'Classes','MyMediaModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','my.media.js']
